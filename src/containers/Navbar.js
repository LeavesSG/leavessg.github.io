...
import { mySVGs } from "../statics/content";
...
export function Navbar(){
    ...
    return <nav className="navbar">
        <div className="navcontainer-left">
            <a className="logo-btn" href="#top"><img className="logo" src={mySVGs.logo} alt="logo" href="#top"/></a>
            ...
            <div className="navcontainer-right">
                ...
                <Link className={currPos=="/topics"?"nav-link selected":"nav-link"} to="/demos"><p>Demos</p></Link>
